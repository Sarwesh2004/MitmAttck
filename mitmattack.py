...
def ascii_format():
    # Initialize colorama to enable ANSI escape character sequences for colored text
    init()
    ...
    # Made By Sarwesh...
    custom_text = "\t\t\t\tMade By Sarwesh"

    # Print the ASCII art with custom text
    print(Fore.BLUE + ascii_art)
    print(Fore.YELLOW + custom_text)
